...
まだこの質問箱のシステムの理解が浅いので拙かったらすみません。まずは質問から見ていきましょう
...
これはおそらく、言い換えれば「説得力のある喋り方とはなにか？」というところなのかなと思っています。
...
触れられたくない話題、避けるべきテーマとして“地雷”という言い方をされることがあります。相手に踏み込まれたくないこととして挙げられますが、会話でそれらをふまないように気をつけています。
...
これに関しては私は「ファシリテート」という概念を大事にしているつもりです。ファシリテートとは、一言で言えば、会話の流れを作ったり、促進したりする役割を持った人のことだと私は解釈していますが、人と会議したりコミュニケーションをするときはおそらくこちらが最適解かなと思っています。その際に相手のコミュニケーションスタンスをある程度把握する必要があります。
...
代表的なのはこの3つかなと思います。このタイプ一つで確定するわけではなく、複合だったりその人の気分によって変わってくるので、この人はこのタイプだと決めつけないことが大切です。
...
### 話していることを受け止めてくれるタイプ
少し前に流行った「聞く力」という本が話題になりましたね。このタイプの方にカテゴライズされると思います。
このタイプはとにかく相槌がうまく、相手のことに興味を持ってくれます。相手のことに興味をもってくれて、一歩離れたところから自分を見ることができるタイプです。

しかし、話者が相槌に反応し、話者が自分語りをしやすくなったり、複数人の場合は自分の話をしなかったりする傾向がある気がします。こういった方から話を引き出すことで、会話全体が暖かくなっていくとおもうので、「この人の話している割合が少なくなってきたな」と思ったとき、話を振っていくことをしていくことができるとなおGoodです。こういうタイプの方は、落ち着いた観察をすることが多く、話すと『なるほど』と思える視点が得られることがよくあります。
...
どちらも良いスタイルであり、違いは“率直に話すか、別の視点から話すか”のようなイメージです。このタイプの方は自発的にいろいろな話題を提供してくれるので、同じように関連性のありそうな話題を提供してみると促進ができるでしょう。

他にも様々なスタンスがあると思うので、「どういうふうな話し方をすれば快適に会話を続けられるか」を考えながら進めていくことで対応していきましょう。

## 緊張への対策
話すときに緊張してしまうことが多いのではないでしょうか？「不快にさせてしまったらどうしよう」「失礼なことをいいたくない」という考え方かなと思います。
まず断言できることは、「そう考えている時点ですでに優しさの塊である」ということです。その視点は本当に大事なので、これからも続けていけることがこれからの宝物になると思います。

ではその緊張をほぐすのに使えそうな話し方なんですが、効果的なのは「前置きの言葉を使う」ということです。
例えば「これは失礼にあたってしまうかもしれないので、そうだったら申し訳ないんですけど」だったり「何もしらない素人な質問で申し訳ないんですけど」という前置きの言葉を入れることで、相手に配慮しながら話すことができます。こうした方法があると知っておくだけでも、緊張が少し和らぐかもしれません。

注意したほうがいい点は「多用するとうっとおしく感じる可能性がある」ということです。そのため、どうしてもなときに使うことがおすすめです。

繰り返しますが、その緊張は相手に興味を持っている前提なので、その心持ちがある時点で緊張というのはいい感情であるということを認識しておいていいと思います。マイナスなことではないので、あとは場数を踏んでこの緊張をほぐしていきましょう

## 頭が良くなる方法
頭が良くなるというのは個人的に2つの観点があると思っています。
それは「知能」と「知性」という言葉でカテゴライズされるものにヒントがあると思います。
個人的な解釈ですが知能と知性はそれぞれ以下のように考えています。

- 知能：受け取ったものから解釈をし出力をするときの処理能力。平たく言うならIQと呼ばれるカテゴリはこれです
- 知性：受け取ったものを正確に捉えられるような引き出しの多さ。こちらはどちらかというと知識の多さとも言いかえられます

この内どちらかを伸ばすことをまずは考えてみてもいいでしょう。
思考の特性にもよるものなので、どっちが適正があるのかを探ってみてください。

知能が高い方は数学的なアプローチが強い傾向があります。基本的な知識を様々に応用できる力があり、未知のことにも独自に対応するというような部分が見えたりすることがあります。記憶している内容よりも今起こっていることにフォーカスを当てることが多いイメージです

知性が高い方は過去の事象と現在の事象を結びつけてアレンジを行う傾向が強いです。知能が高い方と比べて、知識の引き出しの中から素材を選り分けてその中で答えを引き出すということをすることが多いイメージです。

この内容から知能が高い方は思考の割合が多く、知性が高い方は記憶している内容をメインに取り扱います。

私のタイプはどちらかというと知性タイプです。そのため経験している内容や本で読んだ知識、人から聞いた情報を結びつけて考えやすいため、既知に対する部分は対応がしやすいです。そのため、経験を多くすればするほど能力が開花しやすいと思っています。ちなみに、知能タイプの方がどう鍛えているのかは私も気になるところです。そこに関してはまだ引き出しがないので、もしその方がいれば連絡ください・・・
